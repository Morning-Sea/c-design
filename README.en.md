...
> 📖 **Note**: this skill is built by a Chinese-speaking developer. The skill's agent prompts (`SKILL.md`, `references/*.md`) are bilingual-capable — works fine with English tasks.
