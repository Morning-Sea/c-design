#!/usr/bin/env python3
"""
verify.py — Playwright wrapper for verifying HTML produced by claude-design
...
Usage:
    ...
    python verify.py deck.html --slides 10                  # Slide mode: capture each of the first N slides
...
def main():
    ...
    parser.add_argument("--viewports", default="1440x900",
                        help="Comma-separated list of viewports in WxH format (default 1440x900)")
    parser.add_argument("--slides", type=int, default=0,
                        help="Slide mode: capture the first N slides (HTML must support ArrowRight paging)")
